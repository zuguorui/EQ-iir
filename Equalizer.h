...
private:
    ...
    double L_input[SAMPLES_PER_BUFFER];
    double R_input[SAMPLES_PER_BUFFER];

    double lp_out[SAMPLES_PER_BUFFER];
    double bp_out[SAMPLES_PER_BUFFER];
    double hp_out[SAMPLES_PER_BUFFER];

    shared_ptr<ChannelFilter> leftChannelFilter;

    shared_ptr<ChannelFilter> rightChannelFilter;
